...
methods=1:4
kls=array(dim=c(length(Ns),length(methods)+1))
for(i.N in 1:length(Ns)){
  ...
  save(kls,Ns,methods,file='output/compRes_GP_sin_lin.RData')
...
for(i.N in 1:length(Ns)){
  ...
  save(kls,Ns,methods,file='output/compRes_GP_sin.RData')
...
for(i.N in 1:length(Ns)){
  ...
  save(kls,Ns,methods,n,reg,file='output/compRes_GP_sin_random.RData')
...
for(i.N in 1:length(Ns)){
  ...
  save(kls,Ns,methods,file='output/compRes_GP_sin_DPM.RData')
...
### compute log scores for different methods
methods=1:4
ls=array(dim=c(length(Ns),length(methods)+1))
for(i.N in 1:length(Ns)){
  ...
  save(ls,Ns,methods,file='output/compRes_GP_prod.RData')
